<div class="gallery_box">
        ...
        <div class="gallery_box_item_slider">
            <div class="gallery_box_item_slider_img" style="background-image: url({{$refinishingFirstImg}})">
                ...
                <div class="gallery_box_item_slider_img_changer">
                    <div class="slider_prev_button" id="slider_prev_button"><i class="fa-solid fa-arrow-left"></i></div>
                    <div class="slider_next_button" id="slider_next_button"><i class="fa-solid fa-arrow-right"></i></div>
                </div>
            </div>
    ...
    <div class="gallery_box_item">
        ...
        <div class="gallery_box_item_slider">
            <div class="gallery_box_item_slider_img" style="background-image: url({{$refinishingFirstImg}})">
                <div class="slider_switch_button" id="refinishing_switcher"><i class="fa-solid fa-repeat"></i></div>
                <div class="gallery_box_item_slider_img_changer">
