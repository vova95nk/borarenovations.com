    ...
    <div class="container">
        <div class="row">
            <div class="section-head col-sm-12">
                ...
                <p>(EXAMPLE) When you choose us, you'll feel the benefit of 10 years' experience of Web Development. Because we know the digital world and we know that how to handle it. With working knowledge of online, SEO and social media.</p>
            </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="item"> <span class="icon feature_box_col_two"><img src="@if(env('APP_ENV') === 'prod')./public/@endif images/spray-gun2.png" width="60px" height="60px" style="margin: -10px -10px 0 0"></span>
